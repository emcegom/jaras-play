...
import com.github.emcegom.jaras.play.common.helper.MsgHelper;
...
public class AssertUtils {
    ...
    public static void mustTrue(boolean object, String message, Object clue1) {
        if (!object) {
            throw new IllegalStateException(MsgHelper.m(message, clue1));
        }
    }
    ...
    public static void mustTrue(boolean object, String message, Object clue1, Object clue2) {
        if (!object) {
            throw new IllegalStateException(MsgHelper.m(message, clue1, clue2));
        }
    }
    ...
    public static void mustTrue(boolean object, String message, Object clue1, Object clue2, Object clue3) {
        if (!object) {
            throw new IllegalStateException(MsgHelper.m(message, clue1, clue2, clue3));
        }
    }
    ...
    public static void mustEndWith(String value, String end) {
        AssertUtils.mustNotBlank(value, "value is blank");
        AssertUtils.mustNotBlank(end, "end is blank");

        if(!value.endsWith(end)){
            throw new IllegalStateException(MsgHelper.m("{} must end with end{}", value, end));
        }
    }
    ...
    public static void mustStartWith(String value, String start) {
        AssertUtils.mustNotBlank(value, "value is blank");
        AssertUtils.mustNotBlank(start, "end is blank");

        if(!value.startsWith(start)){
            throw new IllegalStateException(MsgHelper.m("{} must end with start{}", value, start));
        }
    }
}
